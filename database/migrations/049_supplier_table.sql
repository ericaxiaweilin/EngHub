...
VALUES 
    (gen_random_uuid(), 'FAC_MECH_001', 'SUP-RES-001', 'Resistor Components Inc.', 'John Smith', '+1-555-0101', 'john@resistors.com', 7, 1000, 5000.0, '贴片电阻、电容等被动元件', TRUE),
    (gen_random_uuid(), 'FAC_MECH_001', 'SUP-CAP-001', 'Capacitor Tech Corp.', 'Emily Chen', '+1-555-0102', 'emily@captech.com', 10, 500, 3000.0, '各类电容器', TRUE),
    (gen_random_uuid(), 'FAC_MECH_001', 'SUP-CHIPS-001', 'Microchip Solutions', 'Mike Johnson', '+1-555-0103', 'mike@microchips.com', 14, 100, 2000.0, 'IC芯片、微控制器', TRUE)
